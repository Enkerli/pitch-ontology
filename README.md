...
**59 bibliographic records** joined by **52 typed edges**, eighteen of which are citations
...
validator refuses it on any other basis: there are eighteen, each naming the reference entry
it came from.
